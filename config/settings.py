"""
Django settings for abdoulwahab_portfolio project.
"""
...
# MEDIA - this creates different folder in Cloudinary
DEFAULT_FILE_STORAGE = 'cloudinary_storage.storage.MediaCloudinaryStorage'


CLOUDINARY_STORAGE['PREFIX'] = 'bilyamine-global/media'
